...
export const IMAGES = {
  ...
  SPORT: sport,
  VIDEO: video,
  VIRTUALWORD: virtualword,
  NFT1: nft1,
  NFT2: nft2,
  NFT3: nft3,
  NFTAVATAR1: nftavator1,
  NFTAVATAR2: nftavator2,
  NFTAVATAR3: nftavator3,
  ...
  COLLECTIONIMG5: collectionimg5,
  COLLECTIONIMG6: collectionimg6,
  FOX: fox,
  SHROMIE: shroomie,
  BEKIND: bekind,
  HEROICON: heroicon,
