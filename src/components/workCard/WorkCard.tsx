...
function WorkCard(props: WorkCardProps) {
  ...
  return (
    <>
      <div className="flex flex-row md:flex-col lg:flex-col p-2 md:p-4 lg:p-4 justify-center items-center w-[315px] h-[157px] md:w-[210px] md:h-[337px] lg:w-[320px] lg:h-[439px] text-white gap-[20px] bg-[#3B3B3B] rounded-[20px]">
