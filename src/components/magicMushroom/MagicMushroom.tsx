        ...
        <div className="flex flex-col px-5  md:flex-row lg:flex-row justify-between items-end mb-[60px] text-white w-[315px] h-[430px] md:w-[670px] md:h-[210px] lg:w-[1050px] lg:h-[220px]">
          ...
          <div className='py-10 md:p-0 lg:p-0 flex flex-col justify-between h-[180px]'>
            ...
            <div className='hidden md:block lg:block'>
              <Button title="See NFT" icon={<IoEyeOutline size={20} color='#A259FF'/>} className='text-black bg-white  rounded-[10px] w-[198px] h-[60px] flex justify-center' />
            </div>
          </div>
          {/* Auction Timer */}
          ...
          <div className=' w-[315px] flex justify-center md:hidden lg:hidden'>
            <Button title="See NFT" icon={<IoEyeOutline size={20} color='#A259FF' />} className='text-black bg-white  rounded-[10px] w-[315px] h-[60px] flex justify-center' />
          </div>
        </div>
      </div>
    </div>
