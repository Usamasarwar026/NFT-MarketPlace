      ...
      <div>
        <div className={`${className}`}>
          ...
          <div className="flex space-x-2 justify-center ">
            {/* Timer Section */}
            <div>
              <div className="text-[38px] font-[700px]">{String(time.hours).padStart(2, "0")}</div>
              <div className="font-[400px] text-[12px]">Hours</div>
            </div>
            <div className="font-bold pt-4">:</div>
            <div>
              <div className="text-[38px] font-[700px]">{String(time.minutes).padStart(2, "0")}</div>
              <div className="font-[400px] text-[12px]">Minutes</div>
            </div>
            <div className="font-bold pt-4">:</div>
            <div>
              <div className="text-[38px] font-[700px]">{String(time.seconds).padStart(2, "0")}</div>
